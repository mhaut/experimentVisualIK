...
const char* __RoboCompJointMotor__CollisionException_name = "RoboCompJointMotor::CollisionException";

struct __F__RoboCompJointMotor__CollisionException : public ::IceInternal::UserExceptionFactory
{
    virtual void
    createAndThrow(const ::std::string&)
    {
        throw ::RoboCompJointMotor::CollisionException();
    }
};

class __F__RoboCompJointMotor__CollisionException__Init
{
public:

    __F__RoboCompJointMotor__CollisionException__Init()
    {
        ::IceInternal::factoryTable->addExceptionFactory("::RoboCompJointMotor::CollisionException", new __F__RoboCompJointMotor__CollisionException);
    }

    ~__F__RoboCompJointMotor__CollisionException__Init()
    {
        ::IceInternal::factoryTable->removeExceptionFactory("::RoboCompJointMotor::CollisionException");
    }
};

const __F__RoboCompJointMotor__CollisionException__Init __F__RoboCompJointMotor__CollisionException__i;
...
{
    return __RoboCompJointMotor__CollisionException_name;
}
